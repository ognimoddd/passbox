...
CREATE TABLE `password_database_tb` (
  ...
  `account_name` varchar(50) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `username` varchar(50) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `password` varchar(50) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `email_address` varchar(50) COLLATE utf8mb4_0900_ai_ci NOT NULL
...
(2, 'github', 'Domingo', 'password', 'domingo@email.com'),
(3, 'facebook', 'user123', 'pass123', 'user123@gmail.com'),
(4, 'instagram', 'user124', 'pass124', 'user124@gmail.com');
...
(3, 'Domingo Guzman', 'root', 'toor', 'email@email.com', '+905342959431');
